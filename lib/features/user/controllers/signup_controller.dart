...
// SignUpController is used to store user data will he signup and also create User Email And Password Authentication for login
...
class SignUpController extends GetxController {
  ...
  void signUp(String username, String email, String password, String Phone,
      String newsletterSubscription) async {
